    ...
    public partial class XepLichNhanVien : MetroFramework.Forms.MetroForm
    {
        ...
        private void XepLichNhanVien_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                this.Height = 144;
                metroPanel1.Location = new Point(312, 120);
        ...
        private void UpdateCongViec()
        {
            try
            {
                SqlConnection Con = KetNoiCSDL.KetNoiSQL();
                Con.Open();
                string ThemNV = string.Format("update PhanCongViec set MaChuyenXe = @MaChuyenXe,NgayDi =@NgayDi,LoTrinh=@LoTrinh,CaTruc=@CaTruc where MaCongViec=@MaCongViec");
                ...
                Com.Parameters.Add(new SqlParameter("@CaTruc", comboBox1.Text.ToString()));
