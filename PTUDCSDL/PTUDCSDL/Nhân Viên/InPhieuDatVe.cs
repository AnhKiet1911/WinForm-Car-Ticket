...
namespace PTUDCSDL
{
    public partial class frmInPhieu : MetroFramework.Forms.MetroForm
    {
        ...
        public void GetPassData_FormDatVe(string str)
        {
            ...
            TienVe = str.Substring(index + 1, LastIndex - 2);
        ...
        private CDatVe GetInfoKhachHang()
        {
            ...
            try
            {
                ...
                string TempTien = TienVe;
                int ixdexTien = TempTien.IndexOf(".");
                if (ixdexTien == -1)
                {
                    Info.TienVe = Convert.ToInt32(TempTien);
                }
                else
                {
        ...
        private void frmInPhieu_Load(object sender, EventArgs e)
        {
            ...
            lblOkane.Text = GetInfoKhachHang().TienVe.ToString();
